...
def _training_function(config: Dict[str, Any]) -> None:
    ...
    model_args, data_args, training_args, finetuning_args, generating_args, vtcl_args = get_train_args(args)
    ...
    elif finetuning_args.stage == "mdpo":
